...
/**
 * Dado un numero minimo y un numero maximo retorna un numero entre estos 2 incluyendolos.
 * @param int $min
 * @param int $max
 * @return int
 */
...
/**
 * Escribe un texto en pantalla de bienvenida al programa.
...
/**
 * Retorna verdadero si cada letra de la palabra ingresada es alfábetica, falso en caso contrario.
 * @param string $cadena
 * @return boolean
 */
...
/**
 * Le indica al usuario que ingrese una palabra de 5 letras y la retorna.
 * @return string 
 */
 ...
 */
function obtenerPuntajeWordix($palabra, $intento)  /* ****COMPLETAR***** parámetros formales necesarios */
{
    $puntaje = 0;
    switch ($intento) {
        case 1:
